...
def restaurant_favorite(request, restaurant_id):
    ...
    fav, created = FavoriteRestaurant.objects.get_or_create(restaurant=restaurant_obj, user=request.POST)
    if created:
        action = "favorite"
    else:
        action = "unfavorite"
...
def restaurant_list(request):
    ...
    my_list = []
    fav_rests = FavoriteRestaurant.objects.filter(user=request.user)
    for res in fav_rests:
